...
to make sure the user is authorized to view the app or sensitive data.

- [ ] What steps can you take in your web apps to keep your data secure?
protected routes that can only be used if you are authenticated through the token.

- [ ] Describe how web servers work.
Web servers store code for websites, or run code on computers.
